<template>
  <div id="app"
       class="min-h-screen bg-grey-lighter p-8"
  >
    ...
    <div class="max-w-xs mx-auto mb-8">
      <media-card>
        ...
        <p>Slot lorem ipsum dolor sit amet, consectetur adipisicing elit. Officia eos accusantium minima architecto natus sequi quisquam incidunt dolorem, adipisci accusamus facere dicta magni, qui consectetur, omnis quis, voluptas tempore quo!</p>
      </media-card>
    </div>
